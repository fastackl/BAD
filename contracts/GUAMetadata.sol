      ...
      string memory attributes =
        string(
          abi.encodePacked(
            ...
            StringsMin.toString(_timestamp),
            '}, {"display_type":"number", "trait_type": "color", "value":',
            StringsMin.toString(uint256(_colorIndex)),
            '}, {"display_type":"number", "trait_type": "bitstream", "value":',
            StringsMin.toString(uint256(uint16(_bitstream))),
            '}, {"display_type":"number", "trait_type": "entropy", "value":',
            StringsMin.toString(_rand)
          )
        );

      if(!StringsMin.compareStrings(_query,"")){
